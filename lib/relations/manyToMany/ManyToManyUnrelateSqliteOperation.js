...
var ManyToManyUnrelateSqliteOperation = function (_QueryBuilderOperatio) {
  ...
  function ManyToManyUnrelateSqliteOperation(knex, name, opt) {
  ...
  ManyToManyUnrelateSqliteOperation.prototype.queryExecutor = function queryExecutor(builder) {
    ...
    return this.relation.joinTableModelClass.query().childQueryOf(builder).delete().whereIn(joinTableRowId, selectRelatedQuery).runAfter(_lodash2.default.constant({}));
  };
