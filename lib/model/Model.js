...
var JoinEagerAlgorithm = function JoinEagerAlgorithm(builder) {
  return new _JoinEagerOperation2.default(builder.knex(), 'eager');
};

var WhereInEagerAlgorithm = function WhereInEagerAlgorithm(builder) {
  return new _WhereInEagerOperation2.default(builder.knex(), 'eager');
};
...
var Model = (_dec = (0, _deprecated2.default)({ removedIn: '0.7.0', useInstead: 'BelongsToOneRelation' }), _dec2 = (0, _deprecated2.default)({ removedIn: '0.7.0', useInstead: 'HasManyRelation' }), _dec3 = (0, _hiddenData3.default)(), _dec4 = (0, _hiddenData3.default)(), (_class = (_temp = _class2 = function (_ModelBase) {
  ...
  Model.prototype.$query = function $query(trx) {
    ...
    return ModelClass.QueryBuilder.forClass(ModelClass).transacting(trx).findOperationFactory(function (builder) {
      return new _InstanceFindOperation2.default(builder.knex(), 'find', { instance: _this2 });
    }).insertOperationFactory(function (builder) {
      return new _InstanceInsertOperation2.default(builder.knex(), 'insert', { instance: _this2 });
    }).updateOperationFactory(function (builder) {
      return new _InstanceUpdateOperation2.default(builder.knex(), 'update', { instance: _this2 });
    }).patchOperationFactory(function (builder) {
      return new _InstanceUpdateOperation2.default(builder.knex(), 'patch', { instance: _this2, modelOptions: { patch: true } });
    }).deleteOperationFactory(function (builder) {
      return new _InstanceDeleteOperation2.default(builder.knex(), 'delete', { instance: _this2 });
  ...
  Model.loadRelated = function loadRelated($models, expression, filters) {
    return this.query().resolve(this.ensureModelArray($models)).findOptions({ dontCallAfterGet: true }).eager(expression, filters).then(function (models) {
